    ...
    for train_ix, test_ix in kf.split(X):
    	...
    	h = dl.fit(X[train_ix], y[train_ix], batch_size=32, nb_epoch=50, show_accuracy=True, 
    	               ...
    	               [
    	                   ...
    	                   ModelCheckpoint('../../../training_output/10k-SLACNormalized-final-logloss-cvFold{}.h5'.format(foldN), monitor='val_loss', verbose=True, save_best_only=True),
...
with open('../../../training_output/10k-NewSLAC-final.yaml', 'wb') as f:
	f.write(dl.to_yaml())
