...
PLOT_DIR = '/user_data/nelson/training_output/100k-maxout-roc-fol8-'
network_eval= '100k-maxout-roc-fold8.npy'
we_str= '../../../training_output/10k-final-slac-maxout-hypercube-unnormalized-roc-cvFold6.h5'
...
plt.title(r'Weighted Deep Network distribution ($p_T \in [250, 300]$ matched to QCD)' + '\n' + 
          r'$m_{\mathsf{jet}}\in [65, 95]$ GeV')
plt.legend()
plt.savefig(PLOT_DIR + 'weighted-deep-net-distribution.png')
plt.show()
