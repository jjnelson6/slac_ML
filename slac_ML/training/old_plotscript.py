...
PLOT_DIR = ''
network_eval= train0PU_test200PU.npy#['10k-maxout-test.npy','100k-maxout-roc-fold8.npy','10k-maxout-test_logloss.npy','100k-maxout-test_logloss.npy']#'10k-maxout-hypercube-test_fold6.npy','100k-maxout-hypercube-test_fold6.npy']
#we_str= '../../../training_output/100k-final-slac-maxout-hypercube-unnormalized-logloss-cvFold6.h5'
...
#y_dl_2 = np.load(network_eval[1])
#y_cube_dl_1=np.load(network_eval[2])
#y_cube_dl_2=np.load(network_eval[3])
...
add_curve(r'Deep Network, 10k-trained on $p_T \in [200, 300]$ GeV', 'red', calculate_roc(signal, y_dl, weights=weights, bins=1000000), discs)
#add_curve(r'Deep Network, 100k-trained on $p_T \in [250, 300]$ GeV', 'blue', calculate_roc(signal, y_dl_2, weights=weights, bins=1000000), discs)
...
fg.savefig(PLOT_DIR+'0PUtrain-200PUtest.png')
plt.show()
...
pt, mass, tau_21, signal, bakground, y_dl_1 = pt[window], mass[window], tau_21[window], signal[window], background[window], y_dl_1
...
add_curve(r'Deep Network, trained on $p_T \in [250, 300]$ GeV 10k-outside cube', 'red', calculate_roc(signal, y_cube_dl_1, weights=cube_weights, bins = 1000000), cube_discs)
add_curve(r'Deep Network, trained on $p_T \in [250, 300]$ GeV 100k-outside cube', 'red', calculate_roc(signal, y_cube_dl_2, weights=cube_weights, bins = 1000000), cube_discs)
...
fg.savefig(PLOT_DIR+'10k-100k-roc-cube-outside.pdf')
"""
